...
O rastreio cognitivo de idosos hoje é aplicado em papel e pontuado à mão. Isso consome tempo de consulta, varia de avaliador para avaliador, não gera registro comparável ao longo do tempo e carece de simplicidade, tanto para o profissional de saúde aplicar quanto para o paciente idoso responder.
...
- Cadastro e login do profissional de saúde (sem login para o paciente).
- Registro de quem aplicou o teste, em que condições, vinculado ao atendimento.
- Tela de resultado para o profissional de saúde mostrando desenhos + escore + quais características influenciaram o escore.
- Tela final para o paciente sem exibir o escore (agradecimento apenas).
- Nenhum dado enviado a servidor externo.

O objetivo será considerado cumprido se cada item acima puder ser demonstrado rodando no tablet, com um profissional de saúde completando o fluxo real de ponta a ponta (login → aplicação → resultado).

## Público-alvo

| Perfil | Necessidade | Como o produto atende |
|---|---|---|
| Paciente idoso | Fazer o teste sem se sentir diminuído ou "reprovado", de forma simples e sem ajuda | Tarefas de desenho, sem exibir escore ao paciente, sem exigir login |
| Profissional de saúde (generalista ou geriatra) | Aplicar em poucos minutos e confiar no resultado | Escore objetivo e reprodutível, exibido junto dos desenhos e da faixa de incerteza |

Os perfis completos estão em [Lean Inception — Personas](lean-inception.md#4-personas).

## Proposta de valor

Diferente de testes tradicionais em papel e de plataformas digitais como DCTclock/Linus Health, que dependem de hardware proprietário, exigem nuvem e foram validadas apenas em população norte-americana. O produto roda em tablet Android comum, funciona 100% offline mantendo os dados na instituição, e é validado e calibrado para as normas da população brasileira, considerando a variação de escolaridade.
...
- Cadastro/login do profissional de saúde e registro de quem aplicou o teste.
...
## Quadro da Lean Inception

O quadro abaixo é o resultado das dinâmicas de Lean Inception conduzidas pela equipe, do qual esta síntese e as páginas de detalhamento foram derivadas.

<iframe
  src="https://embed.figma.com/board/XIDtWqxlvd8MpMwhxj7TPh/Vis%C3%A3o-do-Produto-UNB-FCTE-UNIEURO-MED-2026-2?embed-host=share"
  title="Quadro da Lean Inception do MED no Figma"
  loading="lazy"
  style="width: 100%; height: 600px; border: 1px solid rgba(0, 0, 0, 0.1);"
  allowfullscreen>
</iframe>
...
| 2.0 | Reestruturação do documento no formato Problema/Objetivo do semestre/Público-alvo/Proposta de valor/Escopo, sintetizando o conteúdo da Lean Inception (v1.0) | [Eduardo Ferreira](https://github.com/eduardoferre) | 05/09/2026| [Lucas Mendonça Arruda](https://github.com/lucasarruda9), [Gabriel Lopes de Amorim](https://github.com/BrzGab) | 21/09/2026 |
| 2.1 | Restabelecimento da rastreabilidade da síntese com as páginas de detalhamento, substituindo as referências em texto por links, e registro das demais páginas que compõem a Visão do Produto | [Artur Mendonça Arruda](https://github.com/ArtyMend07) | 18/09/2026 | [Lucas Mendonça Arruda](https://github.com/lucasarruda9), [Gabriel Lopes de Amorim](https://github.com/BrzGab) | 21/09/2026 |
| 2.2 | Padronização dos termos "escore", "desenhos" e "profissional de saúde", ajuste da proposta de valor quanto à calibração para a população brasileira e inclusão do quadro da Lean Inception | [Artur Mendonça Arruda](https://github.com/ArtyMend07) | 21/09/2026 | [Lucas Mendonça Arruda](https://github.com/lucasarruda9), [Gabriel Lopes de Amorim](https://github.com/BrzGab) | 21/09/2026 |
