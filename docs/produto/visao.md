...
| 2.2 | Padronização dos termos "escore", "desenhos" e "profissional de saúde", ajuste da proposta de valor quanto à calibração para a população brasileira e inclusão do quadro da Lean Inception | [Artur Mendonça Arruda](https://github.com/ArtyMend07) | 21/09/2026 | | |
