...
Esta página faz parte da Visão do Produto do MED e registra o detalhamento gerado nas dinâmicas de Lean Inception. A [síntese da visão](visao.md) apresenta o problema, o objetivo do semestre, o público-alvo, a proposta de valor e o escopo em formato condensado. É aqui que ficam os artefatos completos que sustentam aquela síntese.
...
- **Cluster 3 (Experiência do Profissional de Saúde):** Caber nos minutos da consulta; O profissional de saúde entender o resultado sozinho; O profissional de saúde confiar no número; Não dar trabalho extra para o profissional de saúde.
...
### Persona 2: Profissional da Saúde (Dr. Marcelo)
...
### Jornada 3: Profissional da Saúde (Usa pela primeira vez)
...
## Continuação da Lean Inception

As atividades posteriores às jornadas de usuário estão registradas em páginas próprias, todas parte da Visão do Produto:

| Atividade | Conteúdo | Página |
|---|---|---|
| 6 e 7 | Brainstorming de funcionalidades, clusters e revisão técnica, de negócio e de UX | [Funcionalidades](funcionalidades.md) |
| 8 | Sequenciador de ondas do MVP e dos incrementos | [Sequenciador](sequenciador.md) |
| 10 | Canvas MVP, com hipóteses, métricas de validação e custo | [Canvas MVP](canvas-mvp.md) |
...
| 2.0 | Separação do detalhamento da Lean Inception em página própria dentro da Visão do Produto, mantendo o conteúdo original e criando a rastreabilidade por links com a síntese da visão | [Artur Mendonça Arruda](https://github.com/ArtyMend07) | 18/09/2026 | [Lucas Mendonça Arruda](https://github.com/lucasarruda9), [Gabriel Lopes de Amorim](https://github.com/BrzGab) | 21/09/2026 |
| 2.1 | Padronização do termo "escore", troca de "médicos" por "profissionais de saúde" na declaração de visão e ajuste da declaração quanto à calibração para a população brasileira | [Artur Mendonça Arruda](https://github.com/ArtyMend07) | 21/09/2026 | [Lucas Mendonça Arruda](https://github.com/lucasarruda9), [Gabriel Lopes de Amorim](https://github.com/BrzGab) | 21/09/2026 |
