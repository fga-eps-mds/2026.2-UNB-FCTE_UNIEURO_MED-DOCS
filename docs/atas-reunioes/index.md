...
Esta seção reúne o registro das reuniões realizadas entre a equipe, o *Product Owner*
e o cliente, com os pontos discutidos e as decisões de negócio tomadas em cada uma.

O padrão adotado está descrito no [modelo de ata](modelo-ata.md).

**Tabela 1:** Atas registradas

| Ata | Data | Assunto | Participação externa |
|-----|------|---------|----------------------|
| [01](Ata-01-EPS-2026-08-17-PO.md) | 17/08/2026 | Primeiro contato e entendimento do domínio | Cliente |
| [02](Ata-02-EPS-2026-08-24-PO.md) | 24/08/2026 | *Lean Inception* — atividades 1 e 2 | Professor, Cliente |
| [03](Ata-03-EPS-2026-08-31-PO.md) | 31/08/2026 | *Lean Inception* — atividades 3, 4 e 5 | Professor, *Product Owner* |
